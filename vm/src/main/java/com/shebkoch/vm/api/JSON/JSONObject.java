...
//    }
    ...
    public void updateWithString(String string){
        this.clear();
        FillWithJSONTokener(new JSONTokener(string));
    }

    public static boolean isEmpty(JSONObject jsonObject) {
        return NULL.equals(jsonObject) || jsonObject.length() == 0;
    }


    public enum BooleanGetMode{
        /**
         * cast
         * true, "true" to true
         * false, "false" to false
         * null, and other to null
         */
        ONLY_BOOLEAN_VALUE,
        /**
         * cast
         * true, "true", every not null object to true
         * false, "false" to false
         * null, "null" to null
         */
        NOT_NULL_CAST_TO_TRUE,
    ...
    public JSONObject(JSONTokener x) throws JSONException {
        this();
        FillWithJSONTokener(x);
    }
    /**
     * edited
     */
    private void FillWithJSONTokener(JSONTokener x) {
        if (x.nextClean() != '{') {
...
//            return string;
    ...
    public Boolean optBoolean(String key) {
        return this.optBoolean(key, null, BooleanGetMode.NOT_NULL_CAST_TO_TRUE);
    }
    /**
     * edited
     */
    public Boolean optBoolean(String key, BooleanGetMode mode) { return this.optBoolean(key, null, mode); }
    /**
     * edited
     */
    public Boolean optBoolean(String key, Boolean defaultValue, BooleanGetMode mode) {
        ...
        if (NULL.equals(val)) {
            ...
            try {
                ...
                if(mode.equals(BooleanGetMode.ONLY_BOOLEAN_VALUE)) return defaultValue;
                if(mode.equals(BooleanGetMode.NOT_NULL_CAST_TO_TRUE)) return true;
     ...
     * edited
     */
    public BigDecimal optBigDecimal(String key, int precision) {
        Object val = this.opt(key);
    ...
    public String optString(String key) {
        return this.optString(key, true);
    }
    /**
     * edited
     */
    public String optString(String key, boolean ignoreEmpty) {
        String[] ignoredStrings = ignoreEmpty ? new String[]{"[]", "{}"} : new String[]{};
        return this.optString(key, null, ignoredStrings);
    }
    /**
     * edited
     */
    public String optString(String key, String[] ignoredStrings) {
        return this.optString(key, null, ignoredStrings);
    }
    /**
     * edited
     */
    public String optString(String key, String defaultValue, String[] ignoredStrings) {
        Object val = this.opt(key);
        ...
        try {
            if (!(other instanceof JSONObject)) {
                ...
                while(var2.hasNext()) {
                    ...
                    Object valueThis = ((JSONObject)other).get(name);
